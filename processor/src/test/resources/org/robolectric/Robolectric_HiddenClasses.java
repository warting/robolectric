...
public class Shadows implements ShadowProvider {
  ...
  static {
    SHADOW_MAP.put(
        "com.example.objects.Dummy", "org.robolectric.annotation.processing.shadows.ShadowDummy");
    SHADOW_MAP.put(
        "com.example.objects.OuterDummy2",
        "org.robolectric.annotation.processing.shadows.ShadowOuterDummy2");
    SHADOW_MAP.put(
        "com.example.objects.OuterDummy2.InnerPackage",
        "org.robolectric.annotation.processing.shadows.ShadowOuterDummy2$ShadowInnerPackage");
    SHADOW_MAP.put(
        "com.example.objects.OuterDummy2.InnerProtected",
        "org.robolectric.annotation.processing.shadows.ShadowOuterDummy2$ShadowInnerProtected");
    SHADOW_MAP.put(
        "com.example.objects.Private",
        "org.robolectric.annotation.processing.shadows.ShadowPrivate");
    SHADOW_MAP.put(
        "com.example.objects.OuterDummy2.InnerPrivate",
        "org.robolectric.annotation.processing.shadows.ShadowOuterDummy2$ShadowInnerPrivate");
  }
