...
public class CppAssetManager {
  ...
  // transliterated from
  // https://cs.corp.google.com/android/frameworks/base/libs/androidfw/include/androidfw/AssetManager.h
        ...
        switch (asset_path.type) {
          ...
          default:
            throw new IllegalStateException(
                "Unsupported type " + asset_path.type + " for + " + asset_path.path.string());
        }
